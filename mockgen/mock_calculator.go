...
//
//	mockgen -source=calculator.go -destination=mock_calculator.go -package=mockgen
//
...
func (mr *MockCalculatorMockRecorder) Subtract(a, b any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Subtract", reflect.TypeOf((*MockCalculator)(nil).Subtract), a, b)
}
